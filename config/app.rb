...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'checklists.com'
  config.app_name = 'Checklists'
  config.mailer.from = 'Checklists <no-reply@checklists.com>'
  ...
  #
  config.app_secret = 'oAZTuCK1rB7vaqDPUb7t9OKkt8ylCDLrvujRF3Q0v0YpVu76105x4vAhJilB0boMvrY'
